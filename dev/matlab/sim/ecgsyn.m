function [s, ipeaks] = ecgsyn(sfecg,N,Anoise,hrmean,hrstd,lfhfratio,sfint,ti,ai,bi,fresp, flo, fhi, flostd, fhistd)
...
fprintf(fid,'Frecuencia de ruido respiraitorio: %d Hz\n',fresp);
...
x0 = [1,0,0.04];
Tspan = [0:dt:(Nt-1)*dt];
[T,X0] = ode45('derivsecgsyn',Tspan,x0,[],rrn,sfint,ti,ai,bi,fresp);
